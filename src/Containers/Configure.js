        ...
        <Grid container spacing={3}>
            ...
            <div className="panel-box">
              ...
              <div className="panel-body">
                ...
                <div className="greeting-message">
                  <textarea
                    onChange={e => updateGreetingMessage(e)}
              ...
              <div className="panel-footer flex-box">
                <div
                  className="button button-spaicy"
                  onClick={() => saveGreetingMessage()}
                >
                  {fetch_business_data ? "save" : "saving"}{" "}
                </div>
              </div>
            </div>
          </Grid>
          <Grid item xs={12} md={6}>
            <div className="panel-box order-confirmation-box">
              <div className="panel-header">
                {" "}
                <h3 className="title">Store Closed Away Message</h3>
              </div>
              <div className="panel-body">
                {!fetch_order_greeting_data && (
                  <div className="loader-mask" />
                ...
                <div className="greeting-message">
                  <textarea
                    onChange={e => onChangeOrderField(e)}
          ...
          <Grid item xs={12}>
            <div className="locations-hours-container">
              <div className="panel-box">
                <div className="panel-header">
                  {" "}
                  <h3 className="title"> Business Time and Location </h3>
                </div>
                <div className="panel-body">
                  ...
                  <div className="business-timezone flex-box align-item-center">
                    ...
                    <div className="flex-1 timezonelist">
                      <select
                        ...
                        onChange={e => updateBusinessTimeZone(e)}
                      >
                  ...
                  <div className="business-week">
                    {businessHours.map((day, index) => {
                      return (
                        <div
                          className="week-day flex-box align-item-center"
                          key={index}
                        >
                          <div className="day-field">
                            <input
                              ...
                              checked={day.isOpen}
                              value="monday"
                              onChange={this.updateBusinessHours.bind(
                                this,
                                index
                              )}
                            />{" "}
